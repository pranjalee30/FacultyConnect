                ...
                <div className="contact__developer">
                    ...
                    <div className="contact__content">
                        <div className="contact__text-container">
                            <p className="contact__text">Hello! I'm <a href='https://portfolio-six-blue-64.vercel.app/' target='_blank' rel='noopener noreferrer' style={{ color: "rgb(29 191 141)", fontWeight: "400", fontSize: "2rem" }}>Pranjal Kumar</a>, the developer behind <span style={{ color: "rgb(255 0 0)" }}>FacultyConnect</span>. The idea for this website came to me during my own struggles to find professors on our expansive campus. I realized how much time and effort could be saved if there was an easy way to locate faculty members and view their schedules.</p>
